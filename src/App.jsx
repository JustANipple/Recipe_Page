...
function App() {
  ...
  return (
    <>
      <main
        className={`m-auto grid gap-y-9 bg-White md:my-32 md:max-w-desktop md:rounded-3xl md:p-10 md:pb-6 ${modalOpen ? "hidden" : ""}`}
      >
        {/* Header where i'll insert the new button */}
        <div className="flex gap-3">
          <button className="text-black flex gap-1 rounded-md bg-LightGrey px-4 py-2" onClick={handleModal}>
            <p className="my-auto font-Outfit text-Nutmeg">New</p>
          </button>
          <button className="text-black flex gap-1 rounded-md bg-LightGrey px-4 py-2">
            <p className="my-auto font-Outfit text-Nutmeg">Edit</p>
          </button>
          <button className="text-black flex gap-1 rounded-md bg-LightGrey px-4 py-2">
      ...
      <Edit modalOpen={modalOpen} handleModal={handleModal} />
    </>
  );
}
